...
namespace Graph.DataAccess.Migrations
{
    ...
    [Migration("20221016074006_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Graph.Domain.Entities.CryptoAssets.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Graph.Domain.Entities.CryptoAssets.UserSettings", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Graph.Domain.Entities.CryptoAssets.Portfolio", b =>
                {
                    b.HasOne("Graph.Domain.Entities.CryptoAssets.User", "User")
                        .WithMany("Portfolios")
            ...
            modelBuilder.Entity("Graph.Domain.Entities.CryptoAssets.UserSettings", b =>
                {
                    b.HasOne("Graph.Domain.Entities.CryptoAssets.User", "User")
                        .WithOne("Settings")
                        .HasForeignKey("Graph.Domain.Entities.CryptoAssets.UserSettings", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
