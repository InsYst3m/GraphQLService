...
namespace Graph.API.Services
{
	public class CryptoService : ICryptoService
	{
		...
		public async Task<CryptoAssetViewModel?> GetCryptoAssetAsync(string geckoId)
		{
		...
		public async Task<GlobalMarketViewModel?> GetGlobalCryptoMarketDataAsync()
		{
			...
			try
			{
				...
				return new GlobalMarketViewModel
				{
		...
		/// <inheritdoc cref="ICryptoService.GetSupportedCryptoAssetsAsync"/>
		public async Task<List<CryptoAsset>> GetSupportedCryptoAssetsAsync()
		{
			return await _dataAccessService.GetCryptoAssetsLookupAsync() ?? new List<CryptoAsset>();
		}
	}
}
